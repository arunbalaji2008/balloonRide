...
function draw() {
  ...
  if(keyDown(LEFT_ARROW)){
    ...
    balloon = loadImage(balloonImage2, "Images/HotAirBallon01.png");
  }
  else if(keyDown(RIGHT_ARROW)){
    updateHeight(10,0);
    //add the animation of balloon [use balloonImage2]
    balloon = loadImage(balloonImage2,"Images/HotAirBallon02.png");
  }
  else if(keyDown(UP_ARROW)){
    updateHeight(0,-10);
 //add the animation of balloon [use balloonImage2]
    balloon = loadImage(balloonImage2, "Images/HotAirBallon03.png");
